...
3. The numerical values in SQL statements are treated as floating or integer numbers, depends on if the value contains decimal points or is in scientific notation format. E.g. 9999999999999999999 is overflow as the number is greater than the largest integer number. However, 9999999999999999999.0 is treated as a valid floating number. 
